...
/**
 * Callable interface :
 * We usually use Callable interface when :
 * 1.We want to return a result after thread terminated.
 * 2.We want to execute task concurrently but retrieve results
 */
@Slf4j
public class App2 {
    ...
    static class Processor implements Callable<String> {
        ...
        public String call() throws Exception {
            Thread.sleep(1000);
            return new StringBuilder(id).append("|").append(this.getClass().getCanonicalName()).toString();
        }
    }
}
