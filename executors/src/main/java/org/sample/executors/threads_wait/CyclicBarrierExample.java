...
/**
 * CyclicBarrier is :
 * <br>1.A class for synchronization aid that allows a set of threads to all wait for each other to reach a common
 * barrier point.
 * <br>2.CyclicBarriers are useful in programs involving a fixed sized party of threads that must occasionally wait for
 * each other
 ...
 * <br>5.CB also allows for an optional Runnable once per barrier point,after last thread in the party arrives but
 * before any threads are released.
