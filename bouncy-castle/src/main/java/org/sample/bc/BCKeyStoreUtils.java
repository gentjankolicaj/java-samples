...
public class BCKeyStoreUtils {
  ...
  public static PrivateKey getPrivateKey(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword,
  ...
  public static PublicKey getPublicKey(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword,
      String alias) throws GeneralSecurityException, IOException {
    KeyStore keystore = KeyStore.getInstance(keyStoreType.getName(), BC_SECURITY_PROVIDER);
    keystore.load(new FileInputStream(keystorePath.toFile()), keystorePassword.toCharArray());
  ...
  public static KeyPair getKeyPair(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword,
      String alias) throws GeneralSecurityException, IOException {
    KeyStore keystore = KeyStore.getInstance(keyStoreType.getName(), BC_SECURITY_PROVIDER);
    keystore.load(new FileInputStream(keystorePath.toFile()), keystorePassword.toCharArray());
  ...
  public static Certificate getCertificate(Path keystorePath, KeyStoreType keyStoreType, String password,
  ...
  public static KeyStore loadKeyStore(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword)
  ...
  public static void storeKeyStore(Path newKeystorePath, KeyStoreType keyStoreType, String keystorePassword,
