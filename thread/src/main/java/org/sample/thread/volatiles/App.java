...
public class App {
    ...
    /**
     * Read are performed directly on memory(RAM) not on CPU caches.Also, CPU doesn't cache this variable.
     * 1.Variables can be stored on RAM without volatile keyword
     * 2.Multiple threads may use same cache , if are being run on same CPU core.
     */
