package org.sample.thread.stop;

import lombok.extern.slf4j.Slf4j;

/**
 * In this sample I use volatile keyword to read/write variable on RAM, and based on the variable value thread
 * terminates.
 * 1.By using the volatile keyword we guarantee that CPU is not going to cache that variable value.
 * 2.We get the latest value of variable from RAM
 * <p>
