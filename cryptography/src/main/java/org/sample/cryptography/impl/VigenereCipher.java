...
/**
 * Vigenere cipher implementation, works only for UTF-8. For more check <a
 * href="https://en.wikipedia.org/wiki/Vigen%C3%A8re_cipher">Vigenere cipher</a> Encryption : ( plaintext + key )
 * mod(charset-size) => ciphertext Decryption : ( ciphertext - key ) mod(charset-size) => plaintext
 */
@Slf4j
