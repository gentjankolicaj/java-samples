 ...
 */
@Slf4j
public class MaxMessageSizeEchoEndpoint extends Endpoint {

  protected static final String WEBSOCKET_URI = "/prog_msg_size_echo";
  ...
  public void onOpen(Session session, EndpointConfig config) {
    ...
    session.setMaxTextMessageBufferSize(1024); //in bytes
    session.setMaxBinaryMessageBufferSize(1024); //in bytes
    session.setMaxIdleTimeout(10000);//in millis
  }
