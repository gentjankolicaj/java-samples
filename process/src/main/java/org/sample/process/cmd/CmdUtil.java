...
public class CmdUtil {
    ...
    public static CmdOutput execute(boolean runtime,String cmd,String... options) throws CmdException{
        if(runtime)
    ...
    public static CmdOutput executeWithProcessBuilder(String cmd,String... options) throws CmdException{
