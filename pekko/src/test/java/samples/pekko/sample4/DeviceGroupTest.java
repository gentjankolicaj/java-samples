...
import samples.pekko.sample4.DeviceGroup.Command;
import samples.pekko.sample4.DeviceManager.DeviceRegistered;
import samples.pekko.sample4.DeviceManager.ReplyDeviceList;
import samples.pekko.sample4.DeviceManager.RequestAllTemperatures;
import samples.pekko.sample4.DeviceManager.RequestDeviceList;
import samples.pekko.sample4.DeviceManager.RequestTrackDevice;
import samples.pekko.sample4.DeviceManager.RespondAllTemperatures;
import samples.pekko.sample4.DeviceManager.Temperature;
import samples.pekko.sample4.DeviceManager.TemperatureNotAvailable;
import samples.pekko.sample4.DeviceManager.TemperatureReading;
