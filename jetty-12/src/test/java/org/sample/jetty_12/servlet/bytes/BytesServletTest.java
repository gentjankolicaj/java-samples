...
class BytesServletTest {
  ...
  void servlet() throws Exception {
    ...
    //add servlets
    servletContextHandler.addServlet(BytesServlet.class, BytesServlet.SERVLET_PATH);
    ...
    int port = 8081;
    String path = BytesServlet.SERVLET_PATH;
    ...
    assertThat(response.body()).contains(BytesServlet.class.getSimpleName());
