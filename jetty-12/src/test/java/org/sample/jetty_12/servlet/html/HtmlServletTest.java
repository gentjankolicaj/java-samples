...
class HtmlServletTest {
  ...
  void servlet() throws Exception {
    ...
    //add servlets
    servletContextHandler.addServlet(HtmlServlet.class, HtmlServlet.SERVLET_PATH);
    ...
    int port = 8081;
    String path = HtmlServlet.SERVLET_PATH;
    ...
    assertThat(response.body()).contains(HtmlServlet.class.getSimpleName());
