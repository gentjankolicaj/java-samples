...
class AsyncReadHtmlServletTest {
  ...
  void servlet() throws Exception {
    ...
    //add servlets
    servletContextHandler.addServlet(AsyncReadHtmlServlet.class, AsyncReadHtmlServlet.SERVLET_PATH);
    ...
    int port = 8081;
    String path = AsyncReadHtmlServlet.SERVLET_PATH;
    ...
    assertThat(response.body()).contains(AsyncReadHtmlServlet.class.getSimpleName());
