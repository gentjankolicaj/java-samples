 ...
 * @Date: 11/27/24 8:50 PM
 */
class OutputStreamServletTest {
  ...
  void servlet() throws Exception {
    ...
    //add servlets
    servletContextHandler.addServlet(OutputStreamServlet.class, OutputStreamServlet.SERVLET_PATH);
    ...
    int port = 8081;
    String path = OutputStreamServlet.SERVLET_PATH;
    ...
    assertThat(response.body()).contains(OutputStreamServlet.class.getSimpleName());
    ...
    assertThat(response2.body()).contains(OutputStreamServlet.class.getSimpleName());
